...
function asciiToStack(str) {
  var stackStr = libopenmpt._malloc(str.length + 1);
  writeAsciiToMemory(str, stackStr);
  return stackStr;
}

function freeStackString(stackStr) {
...
ChiptuneJsPlayer.prototype.play = function(buffer, dest) {
  this.stop();
...
ChiptuneJsPlayer.prototype.createLibopenmptNode = function(buffer, config) {
  ...
  // FIXME: Replace with: https://developer.mozilla.org/en-US/docs/Web/API/AudioWorkletNode
...
/*
Additional functionality by Melissa Autumn
...
ChiptuneJsPlayer.prototype.estimatedBPM = function() {
  return libopenmpt._openmpt_module_get_current_estimated_bpm(this.currentPlayingNode.modulePtr);
}
ChiptuneJsPlayer.prototype.playingChannels = function() {
  return libopenmpt._openmpt_module_get_current_playing_channels(this.currentPlayingNode.modulePtr);
}
ChiptuneJsPlayer.prototype.speed = function() {
  return libopenmpt._openmpt_module_get_current_speed(this.currentPlayingNode.modulePtr);
}
ChiptuneJsPlayer.prototype.tempo = function() {
  return libopenmpt._openmpt_module_get_current_tempo(this.currentPlayingNode.modulePtr);
}
ChiptuneJsPlayer.prototype.instrumentName = function() {
  return libopenmpt._openmpt_module_get_instrument_name(this.currentPlayingNode.modulePtr);
}
ChiptuneJsPlayer.prototype.channelCount = function() {
  return libopenmpt._openmpt_module_get_num_channels(this.currentPlayingNode.modulePtr);
}
ChiptuneJsPlayer.prototype.instrumentCount = function(index) {
  return libopenmpt._openmpt_module_get_num_instruments(this.currentPlayingNode.modulePtr, index);
}
ChiptuneJsPlayer.prototype.orderCount = function() {
  return libopenmpt._openmpt_module_get_num_orders(this.currentPlayingNode.modulePtr);
}
ChiptuneJsPlayer.prototype.patternCount = function() {
  return libopenmpt._openmpt_module_get_num_patterns(this.currentPlayingNode.modulePtr);
}
ChiptuneJsPlayer.prototype.sampleCount = function() {
  return libopenmpt._openmpt_module_get_num_samples(this.currentPlayingNode.modulePtr);
}
ChiptuneJsPlayer.prototype.subSongCount = function() {
  return libopenmpt._openmpt_module_get_num_subsongs(this.currentPlayingNode.modulePtr);
}

ChiptuneJsPlayer.prototype.sampleName = function(index) {
  return libopenmpt._openmpt_module_get_sample_name(this.currentPlayingNode.modulePtr, index);
}
ChiptuneJsPlayer.prototype.selectedSubSong = function() {
  return libopenmpt._openmpt_module_get_selected_subsong(this.currentPlayingNode.modulePtr);
}
ChiptuneJsPlayer.prototype.subSongName = function(index) {
  return UTF8ToString(libopenmpt._openmpt_module_get_subsong_name(this.currentPlayingNode.modulePtr, index));
}

ChiptuneJsPlayer.prototype.selectSubSong = function(index) {
  const success = libopenmpt._openmpt_module_select_subsong(this.currentPlayingNode.modulePtr, index);
  // Cast as boolean in the worst way possible
  return !!success;
}